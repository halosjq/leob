...
class Cookie
{
     ...
     */
    public static function Set(string $cookie_name, int $resource)
    {
    ...
    /**
     * Establecer un array de cookies
     */
    public static function SetArr(array $cookies)
    {
        self::$cookies = $cookies;
        foreach (self::$cookies as $i => $name) {
            self::Set($name, $i);
        }
    }
